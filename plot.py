...
def draw(filename):
    x = loadText(filename,0)
    y1 = loadText(filename,1)
    plt.plot(x,y1)
    y2 = loadText(filename,2)
    plt.plot(x,y2)
    y3 = loadText(filename,3)
    plt.plot(x,y3)
    y4 = loadText(filename,4)
    plt.plot(x,y4)
    y5 = loadText(filename,5)
    plt.plot(x,y5)
    y6 = loadText(filename,6)
    plt.plot(x,y6)
